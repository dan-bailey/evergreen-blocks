...
class evergreen_blocks_Admin {
	...
	public function add_admin_menu() {
		...
		add_menu_page(
			esc_html__( 'React Setting', 'evergreen-blocks' ),
			esc_html__( 'React Setting', 'evergreen-blocks' ),
			'manage_options',
			$this->plugin_name,
    ...
    public function enqueue_resources() {
         ...
         * defined in evergreen_blocks_Loader as all of the hooks are defined
         * in that particular class.
         *
         * The evergreen_blocks_Loader will then create the relationship
        ...
        wp_enqueue_style( 'at-grid', EVERGREEN_BLOCKS_URL. 'assets/library/at-grid/at-grid.min.css', array(), $this->version );
        ...
        $deps_file = EVERGREEN_BLOCKS_PATH . 'build/admin/settings.asset.php';
        ...
        wp_enqueue_script( $this->plugin_name, EVERGREEN_BLOCKS_URL . 'build/admin/settings.js', $dependency, $version, true );

        wp_enqueue_style( $this->plugin_name, EVERGREEN_BLOCKS_URL . 'build/admin/style-settings.css', array('wp-components'), $version );
    ...
    public function register_settings() {
        $defaults = evergreen_blocks_default_options();
        register_setting(
            'evergreen_blocks_settings_group',
            'evergreen_blocks_options',
            array(
                'type'         => 'object',
                'default'      => $defaults,
                'show_in_rest' => array(
