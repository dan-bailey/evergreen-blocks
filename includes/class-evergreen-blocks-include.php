 ...
 */
class evergreen_blocks_Include {
    ...
    public function add_block_categories( $categories ) {
        ...
        return array_merge(
            array(
                array(
                    'slug'  => 'evergreen-blocks',
                    'title' => __( 'Gutenberg blocks boilerplate', 'evergreen-blocks' ),
                ),
            ),
            $categories
        );
    ...
    public function register_block_types_from_metadata() {
        ...
        foreach ( $block_folders as $block_folder ) {
            register_block_type_from_metadata(
                EVERGREEN_BLOCKS_PATH . 'build/blocks/' . $block_folder
            );
        }
    }
    ...
    public function register_dynamic_blocks() {
        require EVERGREEN_BLOCKS_PATH  . 'build/blocks/step-6-dynamic-block/index.php';
    }
}