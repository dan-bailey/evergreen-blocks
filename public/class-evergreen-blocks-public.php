...
class evergreen_blocks_Public {
	...
	public function enqueue_public_resources() {
        ...
        $deps_file = EVERGREEN_BLOCKS_PATH . 'build/public/public.asset.php';
        ...
        wp_enqueue_script( $this->id, EVERGREEN_BLOCKS_URL . 'build/public/public.js', $dependency, $version, true );

        wp_enqueue_style( $this->id, EVERGREEN_BLOCKS_URL . 'build/public/public.css', array(), $version );
