    ...
    return (
        <>
            <div className="evergreen-blocks-field-wrap">
                <TextControl
                    label={__('Setting 1','evergreen-blocks')}
                    placeholder={__('Enter Text','evergreen-blocks')}
            ...
            <div className="evergreen-blocks-field-wrap">
                <TextControl
                    label={__('Setting 2','evergreen-blocks')}
                    placeholder={__('Enter Another Text','evergreen-blocks')}
