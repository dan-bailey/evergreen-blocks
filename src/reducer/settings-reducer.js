...
const SettingsReducer = (state, action) => {
    ...
    switch (action.type) {
        ...
        case 'FETCH_SETTINGS':
            ...
            if( typeof action.payload.fetchedSettings.evergreen_blocks_options_fetch_settings_errors !== 'undefined'){
                newState.notice = __('An error occurred.','evergreen-blocks');
        ...
        case 'UPDATE_SETTINGS':
            ...
            let canSave = false,
                notice = __('Saved Successfully.','evergreen-blocks'),
                hasError = false;
            if( typeof action.payload.fetchedSettings.evergreen_blocks_options_update_settings_errors !== 'undefined'){
                canSave = true;
                notice = __('An error occurred.','evergreen-blocks');
                hasError = true;
            }
